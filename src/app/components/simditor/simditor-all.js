...
(function() {
  ...
  Uploader = (function(_super) {
    ...
    Uploader.prototype.xhrUpload = function(file) {
      ...
      formData.append("upfile", file.obj);
  ...
  ImageButton = (function(_super) {
    ...
    ImageButton.prototype.renderMenu = function() {
      ...
      createInput = function() {
        ...
        return $input = $('<input type="file" title="上传图片" name="upfile" accept="image/*">').appendTo($uploadItem);
      };
      createInput();
      $uploadItem.on('click mousedown', 'input[name=upfile]', function(e) {
        return e.stopPropagation();
      });
      $uploadItem.on('change', 'input[name=upfile]', function(e) {
    ...
    ImageButton.prototype._initUploader = function() {
      ...
      this.editor.uploader.on('uploadsuccess', function(e, file, result) {
        ...
        $img = file.imgWrapper.find("img");
        console.log(result)
        return _this.loadImage($img, result.data.url, function() {
          file.imgWrapper.find(".mask, .simditor-image-progress").remove();
          _this.popover.srcEl.val(result.data.url);
  ...
  ImagePopover = (function(_super) {
    ...
    ImagePopover.prototype._initUploader = function() {
      ...
      createInput = function() {
        ...
        return _this.input = $('<input type="file" title="上传图片" name="upfile" accept="image/*">').appendTo($uploadBtn);
      };
      createInput();
      this.el.on('click mousedown', 'input[name=upfile]', function(e) {
        return e.stopPropagation();
      });
